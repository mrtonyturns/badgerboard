...
async function getAICosts() {
  ...
  const fixedEstimates = [
    ...
    { label: 'Weekly Auto-Refresh',          estimated_cost: 2.50, count: null, model: 'claude-sonnet-5', note: 'Monday auto-regeneration job' },
    { label: 'Election Night Sync',          estimated_cost: 0.40, count: null, model: 'claude-sonnet-5', note: 'Real-time result ingestion' },
  ];
