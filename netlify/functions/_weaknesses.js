// Shared helper (not an endpoint — see the /_* redirect in netlify.toml).
// CommonJS MIRROR of src/lib/weaknesses.js: the background function cannot
// import from src/, so the pure block is duplicated verbatim here and
// tests/weaknesses.test.mjs fails if the two sentinel blocks ever diverge.
// Edit src/lib/weaknesses.js first, then copy the block into this file.
...
module.exports = { cleanWeaknessText, weaknessSubstance, isLabelOnly, isRealWeakness, extractWeaknesses, WEAKNESS_MIN_CHARS, WEAKNESS_MAX }
