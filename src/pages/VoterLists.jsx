            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <div
                  ...
                  className="border-2 border-dashed border-gray-200 rounded-xl p-6 text-center cursor-pointer hover:border-brand-red hover:bg-red-50/30 focus:outline-none focus:border-brand-red focus:ring-2 focus:ring-brand-navy/40/30 transition-colors"
                >
                  {csvFile ? (
                    <div>
